...
- Android：推荐 **c:geo**，可访问 [c:geo 官网](https://www.cgeo.org/) 或下载 [APK 安装包](https://www.freemindworld.com/tmp/cgeo-release_latest.apk) 进行安装。
...
### 拿到坐标后，怎么快速确定具体位置？ { #locate-cordinates }

可以直接使用 [tools.geocaching.top](https://tools.geocaching.top/)：

1. 打开网站并输入坐标。
2. 等页面生成地图跳转按钮后，按需点击「高德」「百度」或「Apple Map」进入导航。
