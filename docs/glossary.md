...
## DNF
**没有找到**（“Did Not Find）。指寻宝者未能找到藏宝，记录于线上 [Log](#log)。 
...
Ground Zero 之缩写。您的 GPS 设备显示您已到达藏宝地点的位置。在 GZ 处，您距离目标地点的距离为零。
...
Lamp Post Cache 之缩写。一种常见的藏宝类型，通常隐藏在未上锁的灯柱底座下。
...
**感谢你的宝藏**（“Thanks For The Cache”）。当寻宝者找到宝藏后，可以把这句话写在线上 [Log](#log) 或宝藏中的日志本以对[宝藏所有者](#co)表示感谢。有时也写作 T4TC。

附注：请在您在线记录寻宝结果时，至少写几句话。这是亦是对藏宝者创建和放置藏宝点表示感谢的方式。
