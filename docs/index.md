...
## 什么是 Geocaching { #what-is-geocaching }
...
### **Geocaching ≠ 寻宝** { #geocaching-is-not-treasure-hunting }
...
[对于 Geocaching 新玩家：如何创建你的第一个藏宝点](./hiding-a-cache/index.md)

### **了解规则，快乐寻宝** { #know-the-rules }
...
## Geocaching 的基本流程 { #basic-process }
...
## Geocaching 的乐趣在哪里？ { #fun-of-geocaching }
