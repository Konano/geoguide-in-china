...
下面分享一种**成本低、体积小、适合城市环境**的「磁吸微型容器」经典方案。其核心的制作思路是用带垫圈的冷冻管做本体，用磁铁实现快速吸附固定。
...
以上这些材料在淘宝、拼多多、1688 等平台都很容易买到，价格也相当便宜。由于一次购买的材料足以制作数十个容器，建议不要过量购买。
...
- 制作「内胆」（可选，但很实用）
    ...
    - 准备一张签到纸
        - 推荐使用耐用的**防水纸**（网购关键词：石头纸）；没有也可先用普通打印纸
        - 尺寸建议：宽度不大于冷冻管的有效深度（一般不超过 35 mm）
    - 将签到纸卷好后塞入吸管内，再一起放入冷冻管
        - 取日志时更容易倒出/抽出，减少卡住的情况

## 延伸阅读：更多容器 DIY 教程 { #more-diy }

在 geocaching.cn 上也有其他宝友分享的制作方案：

- [用矿泉水瓶盖制作一个藏点容器](https://geocaching.cn/2020/01/make-a-micro-container-with-bottle-caps/)（推荐！）
