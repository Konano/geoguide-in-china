...
## D/T 难度与地形评级参考 { #dt-rating-reference }

在提交藏宝页面时，你需要设置 D/T（Difficulty/Terrain）评级。以下为 Geocaching Help Center 原表格的中文翻译，便于快速对照。

**来源：** [Ratings for difficulty and terrain (D/T)](https://www.geocaching.com/help/index.php?pg=kb.chapter&id=97&pgid=82)

| 评级 | 难度 Difficulty<br>找到并签日志本所需的解题/搜索投入 | 地形 Terrain<br>到达坐标并签日志本所需的体力投入 |
| --- | --- | --- |
| 1.0 | 几分钟内即可找到或解出。 | 徒步距离小于 1 公里，且可供轮椅到达。通常为铺装且平坦路面。 |
| 1.5 | 通常可在 10-15 分钟内找到或解出。 | 徒步距离小于 1 公里。通常较平坦，但不一定可供轮椅到达。 |
| 2.0 | 相对容易，通常可在 30 分钟内找到或解出。 | 徒步距离小于 3 公里，沿清晰路径前进。基本无明显爬升或严重灌木阻挡。 |
| 2.5 | 有一定挑战，但对有经验的玩家仍相对容易。 | 可能有小幅爬升或中等程度的植被阻挡。或者需要做危险操作才可到达。 |
| 3.0 | 谜题或藏点位置有一定难度。 | 可能超过 3 公里，路况多变。因爬升或植被阻挡明显，不适合骑行。 |
| 3.5 | 难度较高，需要做好脑力挑战准备。 | 体力消耗较大。通常为较长距离且地形变化明显的徒步。 |
| 4.0 | 非常困难，可能需要专门知识、充分准备，或多次尝试。 | 体力要求很高。可能包含长距离、密集植被、涉水或明显爬升。 |
| 4.5 | 极其困难，通常需要专门知识或技能。 | 在潜在危险地形上进行高强度移动。 |
| 5.0 | 最高级别的脑力挑战。可能需要专门知识、技能、工具或显著投入，才能找到、解出或打开。 | 需要专业装备。如潜水装备、船只、攀岩装备等。 |

**补充说明：** Event Cache 的难度（Difficulty）固定为 1.0。

## 其他参考资料 { #other-resources }
